...
export default function signup() {
  ...
  let supporting =
    "We provide a safe, friendly, and positive environment to help individuals develop a healthy lifestyle. We do this by creating opportunities for young adults.";
  return (
    <>
