...
import { HiEllipsisHorizontal, HiMapPin } from "react-icons/hi2"
...
export default function index() {
  return (
    <>
      ...
      <main className="p-4 mx-auto my-16 space-y-8 max-w-7xl sm:px-6 lg:px-8">
        <section className="">
          <h1 className="type-headline-medium">Events To Help You Believe</h1>
          ...
          <cite className=" type-body-small">
            Our Events Calander Shows You Which <Link href="/events" className="text-yellow-700 transition-all hover:underline">Porgrams Are Running</Link>.
          </cite>
        </section>
        <section className="">
          <Calander />
...
function Calander() {
  return (
    <div>
      <h2 className="type-title-medium">Upcoming Events</h2>
      <div className="lg:grid lg:grid-cols-12 lg:gap-x-16">
        <div className="mt-10 text-center lg:col-start-8 lg:col-end-13 lg:row-start-1 lg:mt-9 xl:col-start-9">
          <div className="flex items-center text-gray-900">
            ...
            <div className="flex-auto type-title-medium">January</div>
            <button
              type="button"
              className="-m-1.5 flex flex-none items-center justify-center p-1.5 text-gray-400 hover:text-gray-500"
            >
          ...
          <div className="grid grid-cols-7 mt-6 type-label-large">
            <div>M</div>
            <div>T</div>
            <div>W</div>
            <div>T</div>
            ...
            {days.map((day, dayIdx) => (
              <button
                ...
                className={classNames(
                  ...
                  day.isToday && !day.isSelected && 'text-yellow-600',
              ...
              >
                <time
                  ...
                  className={classNames(
                    ...
                    day.isSelected && day.isToday && 'bg-yellow-600',
        ...
        <ol className="mt-4 text-sm leading-6 divide-y divide-gray-100 lg:col-span-7 xl:col-span-8">
          {meetings.map((meeting) => (
            <li key={meeting.id} className="relative flex py-6 space-x-6 xl:static">
              ...
              <Image src={meeting.imageUrl} alt="" className="flex-none rounded-full" fill quality={40} />
              </div>
                ...
                <dl className="flex flex-col mt-2 text-gray-500 xl:flex-row">
                  <div className="flex items-start space-x-3">
                    <dt className="mt-0.5">
                      ...
                      <HiCalendar className="w-5 h-5 text-gray-400" aria-hidden="true" />
                    </dt>
                    <dd>
                  ...
                  <div className="mt-2 flex items-start space-x-3 xl:mt-0 xl:ml-3.5 xl:border-l xl:border-gray-400 xl:border-opacity-50 xl:pl-3.5">
                    <dt className="mt-0.5">
                      ...
                      <HiMapPin className="w-5 h-5 text-gray-400" aria-hidden="true" />
                    </dt>
                    <dd>{meeting.location}</dd>
                  </div>
                </dl>
              </div>
              <Menu as="div" className="absolute right-0 top-6 xl:relative xl:top-auto xl:right-auto xl:self-center">
                <div>
                  <Menu.Button className="flex items-center p-2 -m-2 text-gray-500 rounded-full hover:text-gray-600">
                    <span className="sr-only">Open options</span>
                    <HiEllipsisHorizontal className="w-5 h-5" aria-hidden="true" />
                  </Menu.Button>
                </div>
